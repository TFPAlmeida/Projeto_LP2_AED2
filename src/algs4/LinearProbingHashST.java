...
public class LinearProbingHashST<Key, Value> {
    ...
    private void resize(int capacity) {
        algs4.LinearProbingHashST<Key, Value> temp = new algs4.LinearProbingHashST<Key, Value>(capacity);
        for (int i = 0; i < m; i++) {
            if (keys[i] != null) {
    ...
    public static void main(String[] args) { 
        algs4.LinearProbingHashST<String, Integer> st = new algs4.LinearProbingHashST<String, Integer>();
