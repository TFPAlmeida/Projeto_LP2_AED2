...
public class Interval1D {
     ...
     */
    public static final Comparator<algs4.Interval1D> MIN_ENDPOINT_ORDER  = new MinEndpointComparator();

    /**
     * Compares two intervals by max endpoint.
     */
    public static final Comparator<algs4.Interval1D> MAX_ENDPOINT_ORDER = new MaxEndpointComparator();

    /**
     * Compares two intervals by length.
     */
    public static final Comparator<algs4.Interval1D> LENGTH_ORDER = new LengthComparator();
     ...
     */
    public boolean intersects(algs4.Interval1D that) {
    ...
    public boolean equals(Object other) {
        ...
        algs4.Interval1D that = (algs4.Interval1D) other;
    ...
    private static class MinEndpointComparator implements Comparator<algs4.Interval1D> {
        public int compare(algs4.Interval1D a, algs4.Interval1D b) {
    ...
    private static class MaxEndpointComparator implements Comparator<algs4.Interval1D> {
        public int compare(algs4.Interval1D a, algs4.Interval1D b) {
    ...
    private static class LengthComparator implements Comparator<algs4.Interval1D> {
        public int compare(algs4.Interval1D a, algs4.Interval1D b) {
    ...
    public static void main(String[] args) {
        algs4.Interval1D[] intervals = new algs4.Interval1D[4];
        intervals[0] = new algs4.Interval1D(15.0, 33.0);
        intervals[1] = new algs4.Interval1D(45.0, 60.0);
        intervals[2] = new algs4.Interval1D(20.0, 70.0);
        intervals[3] = new algs4.Interval1D(46.0, 55.0);
