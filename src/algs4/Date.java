 ...
 *  @author Kevin Wayne
 */
public class Date implements Comparable<algs4.Date> {
   ...
   /**
     ...
     */
    public algs4.Date next() {
        if (isValid(month, day + 1, year))    return new algs4.Date(month, day + 1, year);
        else if (isValid(month + 1, 1, year)) return new algs4.Date(month + 1, 1, year);
        else                                  return new algs4.Date(1, 1, year + 1);
    }
     ...
     */
    public boolean isAfter(algs4.Date that) {
     ...
     */
    public boolean isBefore(algs4.Date that) {
        return compareTo(that) < 0;
    }
     ...
     */
    @Override
    public int compareTo(algs4.Date that) {
    ...
    public boolean equals(Object other) {
        ...
        algs4.Date that = (algs4.Date) other;
    ...
    public static void main(String[] args) {
        algs4.Date today = new algs4.Date(2, 25, 2004);
        ...
        algs4.Date birthday = new algs4.Date(10, 16, 1971);
