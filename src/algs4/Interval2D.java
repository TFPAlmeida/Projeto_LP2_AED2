...
public class Interval2D {
     ...
     */
    public boolean intersects(algs4.Interval2D that) {
    ...
    public boolean equals(Object other) {
        ...
        algs4.Interval2D that = (algs4.Interval2D) other;
    ...
    public static void main(String[] args) {
        ...
        algs4.Interval2D box = new algs4.Interval2D(xInterval, yInterval);
        box.draw();
