...
public class SparseVector {
   ...
   /**
     ...
     */
    public double dot(algs4.SparseVector that) {
     ...
     */
    public algs4.SparseVector scale(double alpha) {
        algs4.SparseVector c = new algs4.SparseVector(d);
     ...
     */
    public algs4.SparseVector plus(algs4.SparseVector that) {
        if (this.d != that.d) throw new IllegalArgumentException("Vector lengths disagree");
        algs4.SparseVector c = new algs4.SparseVector(d);
   ...
   /**
    ...
    public static void main(String[] args) {
        algs4.SparseVector a = new algs4.SparseVector(10);
        algs4.SparseVector b = new algs4.SparseVector(10);
        a.put(3, 0.50);
        a.put(9, 0.75);
        a.put(6, 0.11);
        a.put(6, 0.00);
