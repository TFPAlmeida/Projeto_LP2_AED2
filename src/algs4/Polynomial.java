...
public class Polynomial {
     ...
     */
    public algs4.Polynomial plus(algs4.Polynomial that) {
        algs4.Polynomial poly = new algs4.Polynomial(0, Math.max(this.degree, that.degree));
     ...
     * @return the polynomial whose value is {@code (this(x) - that(x))}
     */
    public algs4.Polynomial minus(algs4.Polynomial that) {
        algs4.Polynomial poly = new algs4.Polynomial(0, Math.max(this.degree, that.degree));
        for (int i = 0; i <= this.degree; i++) poly.coef[i] += this.coef[i];
        for (int i = 0; i <= that.degree; i++) poly.coef[i] -= that.coef[i];
        poly.reduce();
     ...
     * @return the polynomial whose value is {@code (this(x) * that(x))}
     */
    public algs4.Polynomial times(algs4.Polynomial that) {
        algs4.Polynomial poly = new algs4.Polynomial(0, this.degree + that.degree);
     ...
     */
    public algs4.Polynomial compose(algs4.Polynomial that) {
        algs4.Polynomial poly = new algs4.Polynomial(0, 0);
        for (int i = this.degree; i >= 0; i--) {
            algs4.Polynomial term = new algs4.Polynomial(this.coef[i], 0);
    ...
    public boolean equals(Object other) {
        ...
        algs4.Polynomial that = (algs4.Polynomial) other;
     ...
     */
    public algs4.Polynomial differentiate() {
        if (degree == 0) return new algs4.Polynomial(0, 0);
        algs4.Polynomial poly = new algs4.Polynomial(0, degree - 1);
     ...
     *         argument point
     */
    public int compareTo(algs4.Polynomial that) {
    ...
    public static void main(String[] args) { 
        algs4.Polynomial zero = new algs4.Polynomial(0, 0);

        algs4.Polynomial p1   = new algs4.Polynomial(4, 3);
        algs4.Polynomial p2   = new algs4.Polynomial(3, 2);
        algs4.Polynomial p3   = new algs4.Polynomial(1, 0);
        algs4.Polynomial p4   = new algs4.Polynomial(2, 1);
        algs4.Polynomial p    = p1.plus(p2).plus(p3).plus(p4);   // 4x^3 + 3x^2 + 1

        algs4.Polynomial q1   = new algs4.Polynomial(3, 2);
        algs4.Polynomial q2   = new algs4.Polynomial(5, 0);
        algs4.Polynomial q    = q1.plus(q2);                     // 3x^2 + 5


        algs4.Polynomial r    = p.plus(q);
        algs4.Polynomial s    = p.times(q);
        algs4.Polynomial t    = p.compose(q);
        algs4.Polynomial u    = p.minus(p);
