...
public class Vector { 
     ...
     */
    public double dot(algs4.Vector that) {
     ...
     * @throws IllegalArgumentException if the dimensions of the two vectors are not equal
     */
    public double distanceTo(algs4.Vector that) {
        if (this.d != that.d) throw new IllegalArgumentException("Dimensions don't agree");
     ...
     * @throws IllegalArgumentException if the dimensions of the two vectors are not equal
     */
    public algs4.Vector plus(algs4.Vector that) {
        if (this.d != that.d) throw new IllegalArgumentException("Dimensions don't agree");
        algs4.Vector c = new algs4.Vector(d);
        for (int i = 0; i < d; i++)
     ...
     * @throws IllegalArgumentException if the dimensions of the two vectors are not equal
     */
    public algs4.Vector minus(algs4.Vector that) {
        if (this.d != that.d) throw new IllegalArgumentException("Dimensions don't agree");
        algs4.Vector c = new algs4.Vector(d);
        for (int i = 0; i < d; i++)
            c.data[i] = this.data[i] - that.data[i];
     ...
     */
    @Deprecated
    public algs4.Vector times(double alpha) {
        algs4.Vector c = new algs4.Vector(d);
        for (int i = 0; i < d; i++)
     ...
     * @return the vector whose value is {@code (alpha * this)}
     */
    public algs4.Vector scale(double alpha) {
        algs4.Vector c = new algs4.Vector(d);
        for (int i = 0; i < d; i++)
            c.data[i] = alpha * data[i];
        return c;
    ...
    public static void main(String[] args) {
        ...
        algs4.Vector x = new algs4.Vector(xdata);
        algs4.Vector y = new algs4.Vector(ydata);

        StdOut.println("   x       = " + x);
        StdOut.println("   y       = " + y);

        algs4.Vector z = x.plus(y);
        StdOut.println("   z       = " + z);
