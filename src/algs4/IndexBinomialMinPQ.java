...
public class IndexBinomialMinPQ<Key> implements Iterable<Integer> {
	...
	public void insert(int i, Key key) {
		...
		x.order = 0;
		nodes[i] = x;
		algs4.IndexBinomialMinPQ<Key> H = new algs4.IndexBinomialMinPQ<Key>();
		H.head = x;
		head = union(H).head;
	}
	...
	private algs4.IndexBinomialMinPQ<Key> union(algs4.IndexBinomialMinPQ<Key> heap) {
	...
	private class MyIterator implements Iterator<Integer> {
		algs4.IndexBinomialMinPQ<Key> data;
		
		//Constructor clones recursively the elements in the queue
		//It takes linear time
		public MyIterator() {
			data = new algs4.IndexBinomialMinPQ<Key>(n, comparator);
