...
public class SeparateChainingHashST<Key, Value> implements Serializable {
    ...
    private void resize(int chains) {
        algs4.SeparateChainingHashST<Key, Value> temp = new algs4.SeparateChainingHashST<Key, Value>(chains);
        for (int i = 0; i < m; i++) {
    ...
    public static void main(String[] args) { 
        algs4.SeparateChainingHashST<String, Integer> st = new algs4.SeparateChainingHashST<String, Integer>();
