...
public final class In {
   ...
   /**
    ...
    public static int[] readInts(String filename) {
        return new algs4.In(filename).readAllInts();
    }
   ...
   /**
    ...
    public static double[] readDoubles(String filename) {
        return new algs4.In(filename).readAllDoubles();
    }
   ...
   /**
    ...
    public static String[] readStrings(String filename) {
        return new algs4.In(filename).readAllStrings();
    }
    ...
    public static int[] readInts() {
        return new algs4.In().readAllInts();
    }
   ...
   /**
    ...
    public static double[] readDoubles() {
        return new algs4.In().readAllDoubles();
    }
   ...
   /**
    ...
    public static String[] readStrings() {
        return new algs4.In().readAllStrings();
    }
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new algs4.In("../stdlib/InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new algs4.In("/n/fs/introcs/www/java/stdlib/InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new algs4.In("G:\\www\\introcs\\stdlib\\InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
