...
public class SET<Key extends Comparable<Key>> implements Iterable<Key> {
     ...
     * @throws IllegalArgumentException if {@code that} is {@code null}
     */
    public algs4.SET<Key> intersects(algs4.SET<Key> that) {
    ...
    public boolean equals(Object other) {
        ...
        algs4.SET that = (algs4.SET) other;
    ...
    public static void main(String[] args) {
        algs4.SET<String> set = new algs4.SET<String>();
        ...
        StdOut.println();
        algs4.SET<String> set2 = new algs4.SET<String>(set);
