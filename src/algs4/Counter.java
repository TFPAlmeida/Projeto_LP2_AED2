 ...
 *  @author Kevin Wayne
 */
public class Counter implements Comparable<algs4.Counter> {
     ...
     */
    @Override
    public int compareTo(algs4.Counter that) {
    ...
    public static void main(String[] args) { 
        ...
        // create n counters
        algs4.Counter[] hits = new algs4.Counter[n];
        for (int i = 0; i < n; i++) {
            hits[i] = new algs4.Counter("counter" + i);
        }
