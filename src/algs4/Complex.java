...
public class Complex {
     ...
     */
    public algs4.Complex plus(algs4.Complex that) {
        double real = this.re + that.re;
        double imag = this.im + that.im;
        return new algs4.Complex(real, imag);
    }
     ...
     * @return the complex number whose value is {@code (this - that)}
     */
    public algs4.Complex minus(algs4.Complex that) {
        double real = this.re - that.re;
        double imag = this.im - that.im;
        return new algs4.Complex(real, imag);
    }
     ...
     * @return the complex number whose value is {@code (this * that)}
     */
    public algs4.Complex times(algs4.Complex that) {
     ...
     */
    public algs4.Complex scale(double alpha) {
        return new algs4.Complex(alpha * re, alpha * im);
    }
     ...
     */
    @Deprecated
    public algs4.Complex times(double alpha) {
        return new algs4.Complex(alpha * re, alpha * im);
    }
     ...
     */
    public algs4.Complex conjugate() {
        return new algs4.Complex(re, -im);
    }
     ...
     */
    public algs4.Complex reciprocal() {
        double scale = re*re + im*im;
        return new algs4.Complex(re / scale, -im / scale);
    }
     ...
     * @return the complex number whose value is {@code (this / that)}
     */
    public algs4.Complex divides(algs4.Complex that) {
     ...
     */
    public algs4.Complex exp() {
        return new algs4.Complex(Math.exp(re) * Math.cos(im), Math.exp(re) * Math.sin(im));
    }
     ...
     */
    public algs4.Complex sin() {
        return new algs4.Complex(Math.sin(re) * Math.cosh(im), Math.cos(re) * Math.sinh(im));
    }
     ...
     */
    public algs4.Complex cos() {
        return new algs4.Complex(Math.cos(re) * Math.cosh(im), -Math.sin(re) * Math.sinh(im));
    }
    ...
    public static void main(String[] args) {
        algs4.Complex a = new algs4.Complex(5.0, 6.0);
        algs4.Complex b = new algs4.Complex(-3.0, 4.0);
